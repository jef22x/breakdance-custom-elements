...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\CountdownTimer",
...
class CountdownTimer extends \Breakdance\Elements\Element
{
    ...
    static function contentControls()
    {
        ...
        "Year",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => ['0' => ['value' => '2021', 'text' => '2021'], '1' => ['text' => '2022', 'value' => '2022'], '2' => ['text' => '2023', 'value' => '2023'], '3' => ['text' => '2024', 'value' => '2024'], '4' => ['text' => '2025', 'value' => '2025'], '5' => ['text' => '2026', 'value' => '2026'], '6' => ['text' => '2027', 'value' => '2027'], '7' => ['text' => '2028', 'value' => '2028'], '8' => ['text' => '2029', 'value' => '2029'], '9' => ['text' => '2030', 'value' => '2030'], '10' => ['text' => '2031', 'value' => '2031']], 'condition' => ['0' => ['0' => ['path' => 'content.timer.timer_type', 'operand' => 'is none of', 'value' => ['0' => 'evergreen']]]]],
        false,
        false,
        [],
      ), c(
        ...
        "Month",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => ['0' => ['text' => 'Jan', 'label' => 'Label', 'value' => 'Jan'], '1' => ['text' => 'Feb', 'value' => 'Feb'], '2' => ['text' => 'Mar', 'value' => 'Mar'], '3' => ['text' => 'Apr', 'value' => 'Apr'], '4' => ['text' => 'May', 'value' => 'May'], '5' => ['text' => 'Jun', 'value' => 'Jun'], '6' => ['text' => 'Jul', 'value' => 'Jul'], '7' => ['text' => 'Aug', 'value' => 'Aug'], '8' => ['text' => 'Sep', 'value' => 'Sep'], '9' => ['text' => 'Oct', 'value' => 'Oct'], '10' => ['text' => 'Nov', 'value' => 'Nov'], '11' => ['text' => 'Dec', 'value' => 'Dec']], 'condition' => ['0' => ['0' => ['path' => 'content.timer.timer_type', 'operand' => 'is none of', 'value' => ['0' => 'evergreen']]]]],
        false,
        false,
        [],
      ), c(
...
'onMountedElement' => [['script' => '(function() {
    ...
    {
        return ['0' => ['path' => 'settings.advanced.attributes[].value', 'accepts' => 'string'], '1' => ['accepts' => 'string', 'path' => 'content.timer.year'], '2' => ['accepts' => 'string', 'path' => 'content.timer.month'], '3' => ['accepts' => 'string', 'path' => 'content.timer.days'], '4' => ['accepts' => 'string', 'path' => 'content.timer.hours'], '5' => ['accepts' => 'string', 'path' => 'content.timer.minutes'], '6' => ['accepts' => 'string', 'path' => 'content.timer.seconds']];
    }
